...
Whatever tools you use, document them. Keep a record of which AI tools you used, at what stages, and for what purposes. Some funders are beginning to require disclosure, and even where disclosure is not yet required, having that documentation protects you if questions arise later. The AI Usage Cards framework provides a structured way to do this {cite}`Wahle_2023_AI_Usage_Cards`. Chapter 11 covers how to maintain a Usage Card throughout your project and how to translate it into a methods disclosure at submission (see [Checking AI Output](ch11_validation.md)).
